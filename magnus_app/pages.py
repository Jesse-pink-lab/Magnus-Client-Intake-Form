        ...
        'sections': [
            {
                ...
                'fields': [
                    ...
                    },
                    {
                        ...
                        'placeholder': 'Select one objective',
                        'validate': 'investment_objective',
                    },
                ],
            },
            {
                ...
                'fields': [
                    ...
                    {
                        'name': 'assets_held_away_total',
                        'type': 'text',
                        'label': 'Assets Held Away – Total (USD)',
                        'required': False,
                        'validate': 'usd_currency_0_1b',
                        'placeholder': '$0.00',
                    },
                    {
                        'name': 'assets_held_away_liquid',
                        'type': 'text',
                        'label': 'Assets Held Away – Liquid (USD)',
                        'required': False,
                        'validate': 'usd_currency_0_1b',
                        'placeholder': '$0.00',
                    },
                    {
                        'name': 'assets_held_away_other_brokers',
                        'type': 'text',
                        'label': 'Assets Held Away at Other Brokerage Firms (USD)',
                        'required': False,
                        'validate': 'usd_currency_0_1b',
                        'placeholder': '$0.00',
                    },
